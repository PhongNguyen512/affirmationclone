...
<form id="submitForm" class="" method="POST" action="{{ route('items.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <!-- Add New Post Form -->
            <div class="card card-small mb-3">
                <div class="card-body">
                    ...
                    <input class="form-control form-control-lg mb-3" type="text" name="item_title" placeholder="Your Post Title" required>
                    ...
                    <div class="input-group mt-3">
                        ...
                        <input name="background_color" type="hidden" id="color_value" value="141FFF">
                            ...
                            <fieldset>
                                @foreach($categories as $c)                                    
                                    <div class="custom-control custom-radio mb-1">
                                        <input type="radio" id="category{{$c->id}}" name="categorySelection" id="category{{$c->id}}" 
                                        value="{{$c->id}}" class="custom-control-input" {{ $c->category_title == "Uncategory" ? 'checked' : '' }}>
                            ...
                            <fieldset>
                                @foreach($groupItems as $gi)
                                    <div class="custom-control custom-radio mb-1">
                                        ...
                                        class="custom-control-input" {{ $gi->group_item_title == "Untitle Group" ? 'checked' : '' }}>
